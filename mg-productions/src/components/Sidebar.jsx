...
const Sidebar = () => {
  ...
  return (
    <div className='sticky top-0 w-20 bg-white h-screen flex z-30'>
      <aside className="h-full w-full flex flex-col items-center border-r border-gray-200">
        ...
        <nav className="flex flex-1 flex-col gap-y-4 pt-10">
          <Link className="group relative p-2 hover:bg-gray-50 rounded-xl text-gray-900 mt-6 tooltip tooltip-right" data-tip="Home" to={'/'}>
            <FaHome className='h-5 w-5'/>
          </Link>
          
          <Link className="group relative p-2 hover:bg-gray-50 rounded-xl text-gray-900 mt-2 tooltip tooltip-right" data-tip="Search" to={'/Search'}>
          ...
          (
            ...
            <Link className="group relative p-2 hover:bg-gray-50 rounded-xl text-gray-900 mt-2 tooltip tooltip-right" data-tip="Dashboard" to={'/Dashboard'}>
              <RxDashboard className='h-5 w-5'/>
            </Link>
          ):(
            <Link className="group relative p-2 hover:bg-gray-50 rounded-xl text-gray-900 mt-2 tooltip tooltip-right" data-tip="Request" to={'/request'}>
