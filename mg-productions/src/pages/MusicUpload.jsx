...
function MusicUpload() {
  return (
    <div
      className="relative min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 bg-gray-100 bg-no-repeat bg-cover relative items-center"
    >
      ...
      <div className="sm:max-w-lg w-full p-10 bg-white rounded-xl z-0">
        ...
        <form className="mt-8 space-y-3" action="#" method="POST">
          ...
          <p className="text-sm text-gray-300">
            <span>File type: image files</span>
          </p>
          <div>
            <button
              type="submit"
